...
def button():
	BUTTON=[[InlineKeyboardButton(text="👨🏻‍💻 Sahibim 👨🏻‍💻",url="t.me/SaygisizlarSahip")]]
	BUTTON+=[[InlineKeyboardButton(text="👨🏻‍💻 Grubum 👨🏻‍💻",url="t.me/SaygisizlarS")]]
